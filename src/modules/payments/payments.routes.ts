...
import { gamingCenterIdMiddleware } from '../../common/middleware/gamingCenterId.middleware';
...
router.post(
  '/:reservationId/payments/init', // Path is now relative to `/gamingCenters/:gamingCenterId/reservation`
  authMiddleware,
